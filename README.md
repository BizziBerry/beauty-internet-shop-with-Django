...
Приветствуются contributions! Не стесняйтесь отправлять pull requests или открывать issues для предложений.
...
## ⭐ Поставьте звездочку этому репозиторию, если он помог вам в изучении Django ORM!
